...
CLONE_GITHUB_URL=https://github.com/codenvy/che-core.git
CLONE_VSTS_URL=https://che-1.visualstudio.com/DefaultCollection/test/_git/che-core
ATTEMPTS=2
